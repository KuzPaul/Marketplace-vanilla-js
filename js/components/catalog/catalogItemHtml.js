export const elementCardHtml = (product, flag = false) => {
  return ` <div class="product-card ${flag ? "product-card--small" : ""}">
                  <div class="product-card__visual">
                    <img class="product-card__img" src="${
                      product.image
                    }" height="436" width="290"
                      alt="Изображение товара" loading="lazy">
                    <div class="product-card__more">
                      <button href="#" class="product-card__link btn btn--icon" data-id=${product.id} >
                  ...
                  <div class="product-card__info">
                    ...
                    ${
                      product.price.new
                        ...
                        <span class="product-card__old-number">${new Intl.NumberFormat(
                          "ru-RU",
                        ).format(product.price.old)}</span>
